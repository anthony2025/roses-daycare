export default {
  articles: {
    ...
    f82a: {
      ...
      text:
        'We follow the Funshine Curriculum™ and a myriad of science and exploration activities. Combined with lots of love and hugs we make sure our kids minds are stimulated in all possible areas. From kinetic, dance, movement exercises to science, color and crafts projects, we make sure kids are exposed to all the marvelous ways their creativity can blossom.',
